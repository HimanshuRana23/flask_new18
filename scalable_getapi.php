...
/*
 * Generic GET API endpoint
 * -----------------------
 * This file is an extraction of the original monolithic `getapi.php` script
 * which contained several bespoke endpoints.  It now focuses solely on a
 * scalable implementation that can service most GET requests by accepting
 * table, column and condition parameters.  All legacy logic has been removed
