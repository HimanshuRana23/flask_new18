...
Method      : POST
URL         : https://flask.dfos.co/scalable_apis/companyWiseData/getModules.php
Description : This API retrieves all modules associated with a specific company ID.
              It accepts `option_id` as the Company ID and optionally processes `selected_values`
              to extract a server ID. It returns a list of module IDs and names formatted
              for use in a drill-down field selection structure.
*/
