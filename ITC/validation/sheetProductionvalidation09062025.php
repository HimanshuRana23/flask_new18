<!-- sheet production validation.php -->
<?php

/*
Created By : @Udit Prajapati - 25032025
Created for : Sheet Production Validation
*/
                ...
                if(!empty($base_qty_recvd) && !empty($material) && !empty($actual_reel_width) && !empty($width) && !empty($length))
                {
                 ...
                 // Extract GSM (Remove first 5 characters from material)
                  ...
                  // Length remains unchanged
                    ...
                    // Final Calculation
                    $final_value = ($gsm * $final_length * $breadth * $no_of_sheet) / pow(10, 7);

                 //   echo "Final Value: " . $final_value;
                     
                    $message = "GSM: $gsm, Length: $final_length, Breadth: $breadth, Number of Sheets: $no_of_sheet, Final Value: $final_value, base_qty_recvd = $base_qty_recvd";
