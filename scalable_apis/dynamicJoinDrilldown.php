...
Description : This dynamic API performs a JOIN on two tables (table1, table2) using a common column (on_condition) and fetches specific columns from each.
It supports:

Fetching drilldown values from joined records

Filters using option_id and additional JSON-based conditions

Conditional soft-delete handling using is_deleted

Output is returned in drilldown format with option_id, option_name, and option_value
